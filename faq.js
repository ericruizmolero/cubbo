document.addEventListener('DOMContentLoaded', () => {
  ...
  // Comprobación de seguridad: Si no hay elementos o GSAP no está cargado, salir para evitar errores
  if (faqItems.length === 0 || typeof gsap === 'undefined') {
    console.warn('FAQ Script: No se encontraron elementos .faq_item o GSAP no está cargado.');
    return;
  }
  ...
  faqItems.forEach(item => {
    ...
    question.addEventListener('click', () => {
      ...
      // Comportamiento Acordeón: cierra las demás al abrir una nueva
