document.addEventListener("DOMContentLoaded", () => {
    ...
    // --- ESTADO INICIAL ---
    // NUEVO: Si existe el elemento con el atributo, leemos su texto. 
    // Si no existe (por ejemplo, en la página principal del blog), usamos el valor por defecto.
    ...
    // --- 3. ACTUALIZAR NÚMEROS DE CATEGORÍA Y BOTÓN ACTIVO ---
    categoriasBtns.forEach(btn => {
        ...
        // NUEVO: Ahora comparamos contra la "categoriaActual" que detectamos al inicio, 
        // no solo contra el texto "Todos los artículos".
