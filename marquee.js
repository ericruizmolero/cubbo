function initDraggableMarquee() {
  ...
  wrappers.forEach((wrapper) => {
    ...
    const duration = getNumberAttr(wrapper, "data-duration", 150);
    ...
    // Helper: burst in fast then decelerate to base speed
    function playEntryBurst() {
      gsap.killTweensOf(timeScale);
      timeScale.value = baseDirection * 1;
      gsap.to(timeScale, {
        value: baseDirection,
        duration: 1.8,
        ease: "power3.out",
